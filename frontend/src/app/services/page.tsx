...
const services = [
  {
    ...
    features: ['Custom Web Applications', 'E-commerce Solutions', 'Landing Pages & Marketing Sites', 'Progressive Web Apps (PWAs)', 'CMS Integration', 'Performance Optimization'],
    slug: 'websites',
    ...
    <div className="pt-[72px]" data-testid="services-page">
      <Section>
          ...
          {services.map((service) => (
            ...
            >
              <div className="relative h-40 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--surface-1)] via-[var(--surface-1)]/60 to-transparent" />
                <div className="absolute bottom-4 left-6 w-12 h-12 flex items-center justify-center bg-[var(--gold)] text-[var(--void)]">
        ...
        <div className="mt-16 text-center">
          ...
          <Button href="/contact" variant="primary" data-testid="services-consult-cta">
