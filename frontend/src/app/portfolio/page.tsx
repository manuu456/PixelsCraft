...
const projects = [
  {
    ...
    description: 'CVE tracking and vulnerability management platform for security professionals and developers.',
    category: 'Security',
  ...
  },
  {
    ...
    description: 'AI-powered text transformation tool that converts AI-generated content into natural, human-like text.',
    category: 'AI Tool',
  ...
  },
  {
    ...
    description: 'Digital healthcare platform connecting patients with medical professionals through seamless telemedicine.',
    category: 'Healthcare',
  ...
  },
  {
    ...
    description: 'Advanced chess AI with strategic analysis, move suggestions, and interactive gameplay.',
    category: 'AI Tool',
            ...
            <button
              ...
              className={`px-5 py-2 text-sm font-medium transition-all ${
                cat === 'All'
                  ...
                  : 'bg-[var(--surface-2)] text-[var(--text-secondary)] border border-[var(--border-subtle)] hover:border-[var(--border-gold-active)] hover:text-[var(--gold)]'
              }`}
            >
              {cat}
            </button>
              ...
              <Wrapper key={project.slug}>
                <GlassCard padding="none" className="overflow-hidden group cursor-pointer h-full">
                  <div className="relative h-52 overflow-hidden">
                    ...
                    {project.featured && (
                      <span className="absolute top-3 left-3 px-3 py-1 text-xs font-bold text-[var(--void)] bg-[var(--gold)]">Featured</span>
                    )}
                    <span className="absolute top-3 right-3 px-3 py-1 text-xs font-bold text-[var(--void)] bg-white/90">{project.category}</span>
                    {!project.url && (
                      <span className="absolute bottom-3 left-3 px-3 py-1 text-xs font-semibold text-[var(--void)] bg-white/90">Coming Soon</span>
                    )}
                  </div>
                  <div className="p-6">
                    <p className="text-xs text-[var(--gold)] font-bold uppercase tracking-[0.15em] mb-1">{project.subtitle}</p>
                    <h3 className="font-heading text-xl font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[var(--gold)] transition-colors">
                      {project.title}
                    </h3>
